      ...
      <div className="glass-card w-full max-w-md p-10 relative z-10 animate-fade-in flex flex-col items-center text-center shadow-[0_0_50px_rgba(0,0,0,0.8)] border border-white/[0.08]">
        ...
        <div className="w-full space-y-4">
          ...
          <button 
            ...
            className="w-full flex items-center justify-center space-x-2 bg-white/5 hover:bg-white/10 text-slate-300 py-3 rounded-2xl font-semibold text-xs tracking-wide transition-all border border-white/10"
          >
            <Zap size={14} className="text-cyan-400" />
            <span>Demo Fast Sign In (QA / Guest)</span>
          </button>
        </div>
      </div>
    </div>
